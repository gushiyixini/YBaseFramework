...
public interface IView extends IBaseView {
    ...
    /**
     * {@link IView#created}后调用，可以调用{@link com.yelj.ybaseframework.mvp_helper.helper.EventHelper#click}
     * 等方法为控件设置点击事件，一般推荐使用{@link com.yelj.ybaseframework.mvp_helper.helper.EventHelper#click (IPresenter presenter, View ...views)}
